...
void PluginTest1AudioProcessor::updateFilter(){
    //update param for processes here
    //get parameters from dial
...
void PluginTest1AudioProcessor::process(dsp::ProcessContextReplacing<float> context){
    
    //do processing here and ouput
